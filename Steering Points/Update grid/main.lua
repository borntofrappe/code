...
function love.keypressed(key)
  if key == "r" then
    particleSystem:updateParticles(STRINGS.rocket)
  elseif key == "b" then
    particleSystem:updateParticles(STRINGS.blog)
  elseif key == "c" then
    particleSystem:updateParticles(STRINGS.codepen)
  elseif key == "f" then
    particleSystem:updateParticles(STRINGS.freecodecamp)
  elseif key == "g" then
    particleSystem:updateParticles(STRINGS.github)
  elseif key == "t" then
    particleSystem:updateParticles(STRINGS.twitter)
  end
end
